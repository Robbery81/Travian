...
export class ResourcesComponent implements OnInit {
  fields = [
    {
      index: 1,
      type: ResourceFieldTypeEnum.CENTER_VILLAGE,
    ...
    },
    {
      index: 2,
      level: 1,
      type: ResourceFieldTypeEnum.LUMBER,
    ...
    },
    {
      index: 3,
      level: 1,
      type: ResourceFieldTypeEnum.CROP,
    ...
    },
    {
      index: 5,
      level: 1,
      type: ResourceFieldTypeEnum.IRON,
    ...
    },
    {
      index: 6,
      level: 1,
      type: ResourceFieldTypeEnum.CLAY,
  ...
  prices = [
    ...
    { lumber: 20, clay: 20, iron: 20, crop: 20 },
    { lumber: 30, clay: 30, iron: 30, crop: 30 },
    { lumber: 40, clay: 40, iron: 40, crop: 40 },
    { lumber: 50, clay: 50, iron: 50, crop: 50 },
    { lumber: 60, clay: 60, iron: 60, crop: 60 }
  ];
  ...
  private setPrice(field: ResourceFieldTypeEnum, level: number): any {
    switch (field) {
      case ResourceFieldTypeEnum.LUMBER:
        return this.prices[level];
      case ResourceFieldTypeEnum.CLAY:
        return this.prices[level];
      case ResourceFieldTypeEnum.IRON:
        return this.prices[level];
      case ResourceFieldTypeEnum.CROP:
        return this.prices[level];
      default:
        return {
          lumber: 0,
